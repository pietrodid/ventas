...
class ProductosModel extends Query{
    ...
    public function registrarProducto(string $codigo, string $nombre, int $precio_compra, int $precio_venta, int $id_medida, int $id_categoria)
    {
        $this->codigo = $codigo;
        $this->nombre  = $nombre;
    ...
    public function modificarProducto(string $codigo, string $nombre, int $precio_compra, int $precio_venta, int $id_medida, int $id_categoria, int $id)
    {
        $this->codigo = $codigo;
        $this->nombre  = $nombre;
        $this->precio_compra = $precio_compra;
        ...
        $this->id_categoria = $id_categoria;
        $this->id      = $id;
        $sql = "UPDATE productos SET codigo = ?, descripcion = ?, precio_compra = ?, precio_venta = ?, id_medida = ?, id_categoria = ?, id = ? WHERE id = $id";
