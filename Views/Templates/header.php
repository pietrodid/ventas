...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Post Venta</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link " href="<?php echo base_url; ?>Medidas">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-scale-unbalanced text-primary"></i></div>
                                Medidas
                            </a>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo base_url; ?>Cajas"><i class="fas fa-box text-primary"></i>&nbsp;Cajas</a>
                                </nav>
                            </div>
                        </div>
                    </div>
